...
# ============================================================
TOKEN = '8605400191:AAF4MaZvG_5MUSCnQBJkwCBU7gOhSvxv9Rs'  # Replace with your bot token
MONGO_URI = 'mongodb+srv://rj5706603:O95nvJYxapyDHfkw@cluster0.fzmckei.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'  # Replace with your MongoDB URI
FORWARD_CHANNEL_ID = -1003476877991  # Replace with your channel ID
CHANNEL_ID = -1003476877991  # Replace with your channel ID
error_channel_id = -1003476877991  # Replace with your error channel ID
# ============================================================
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="🪀 JOIN CHANNEL 🪀", url="https://t.me/+84dzjkgSdKtkYmE1")
    button1 = types.InlineKeyboardButton(text="💔 Contact Owner 💔",
...
def handle_attack_command(message):
    ...
    try:
        ...
        for remaining in range(duration, 0, -1):
            ...
            remaining_time = max(0, bot.attack_duration - int(elapsed))
...
def myinfo_command(message):
    try:
        ...
        if not user_data:
            ...
            markup = types.InlineKeyboardMarkup()
            button1 = types.InlineKeyboardButton(text="☣️ Contact Owner ☣️",
                                                 url="https://t.me/VIPXOWNER8")
            button2 = types.InlineKeyboardButton(
                text="💸 Price List 💸", url="https://t.me/c/3661090730/2632")
            markup.add(button1)
            markup.add(button2)
        else:
...
def canary_command(message):
    ...
    button1 = types.InlineKeyboardButton(
        ...
        url="https://t.me/c/3661090730/1558")
    button2 = types.InlineKeyboardButton(
...
if __name__ == "__main__":
    # Compile bgmi.c first if needed
    if os.path.exists("bgmi.c"):
